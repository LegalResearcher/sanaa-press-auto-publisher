...
from sanaa_press_news_bot import (
    ...
    RSS_YPAGENCY_INTL_URL,
    RSS_YPAGENCY_INTL_CATEGORY,
...
SELECTED_FEEDS = {
    ...
    # بقسم "شؤون دولية" ثابتاً (RSS_YPAGENCY_INTL_CATEGORY):
    RSS_YPAGENCY_INTL_URL: RSS_YPAGENCY_INTL_CATEGORY,
    # فيدا قسمي "تقارير" و"تحليلات" بوكالة الصحافة اليمنية — مفعّلان، تُنشر
    # أخبارهما بقسم "أخبار وتقارير" ثابتاً:
